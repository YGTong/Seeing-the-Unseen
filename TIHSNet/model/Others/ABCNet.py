...
class ABCNet(nn.Module):
    def __init__(self,  num_classes=2, pretrained=True):
        ...
        if self.training:
            self.conv_out16 = Output(256, 64, num_classes, up_factor=8)
            self.conv_out32 = Output(512, 64, num_classes, up_factor=16)
        self.init_weight()
    ...
    def forward(self, x):
        ...
        feat_out = self.segmentation_head(feat_fuse)
        # if self.training:
