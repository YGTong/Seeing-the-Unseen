# from FasterNet.detection.backbones.fasternet import fasternet_s
...
class NewUnet(nn.Module):
    def __init__(self, in_channels, num_classes, pretrained=True, backbone='vgg', *args, **kwargs):
    ...
    def forward(self, x):
        ...
        out = self.conv2(self.conv1(out3))
        ...
        out7 = torch.nn.functional.interpolate(out7, size=(x.size(2), x.size(3)), mode='bilinear', align_corners=True)
    
        return out7

if __name__ == '__main__':
    net = NewUnet(3, 1, False)
